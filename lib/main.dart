...
import './startModule/login.dart';
import './startModule/createAccount.dart';
import './startModule/termsAndConditions.dart';
import './startModule/forgotPassword.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes:{
          ...
          "/termsAndConditions":(context)=>TermsAndConditionsForm(),
